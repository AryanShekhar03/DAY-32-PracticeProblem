...
insert into AddressBook(first_name, last_name,Address,City,State,Zipcode,Phone_No,Email_Id)
values('Rahim','Singh','321 south hope st','jaipur','rj',40021,7798545515,'sumit1@gmail.com')

insert into AddressBook(first_name, last_name,Address,City,State,Zipcode,Phone_No,Email_Id)
values('Kishwar','shekar','121 north hope st','saket','new delhi',558855,8888888888,'Kishwar123@gmail.com')

insert into AddressBook(first_name, last_name,Address,City,State,Zipcode,Phone_No,Email_Id)
values('Deepshika','k','125 south hope st','karol bhag','new delhi',99855,7798148855,'Deep1@gmail.com')

insert into AddressBook(first_name, last_name,Address,City,State,Zipcode,Phone_No,Email_Id)
values('Sumit','c','785 east hope st','mumbai','maharashtra',402553,7798544551,'dip1@gmail.com')
...
UPDATE [AddressBook] SET name = 'jeet'  WHERE first_name = 'Rahul';

UPDATE [AddressBook] SET type = 'relative'  WHERE first_name = 'Rohit';
